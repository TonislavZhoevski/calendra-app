...
// Define a vallidation schema for the event form using Zod
export const eventFormSchema = z.object({
  // 'name' must be a string and is requiered (at least 1 character)
  name: z.string().min(1, "Required"),

  // 'description' is an optional string field
  description: z.string().optional(),

  // 'isActive' is aboolean value that defaults to true if not provided
  isActive: z.boolean(),
